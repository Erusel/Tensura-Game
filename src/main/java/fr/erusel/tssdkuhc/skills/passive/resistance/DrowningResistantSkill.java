...
public class DrowningResistantSkill extends Skill implements PassiveSkill {

    public DrowningResistantSkill() { super("Drowning Resistant", "Cancel Drowning Damage", SkillTier.RESISTANCE, 0, null);}
